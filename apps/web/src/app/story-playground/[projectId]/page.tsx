                        ...
                        <div className="p-3">
                          ...
                          <div className="mt-3 grid gap-2">
                            ...
                            {!isR16 && criticRun?.recommendation && criticRun.recommendation !== 'APPROVE' && (
                              <button onClick={() => regenerateFromCritic.mutate({ projectId, criticRunId: criticRun.id, model: 'FLUX' })} disabled={regenerateFromCritic.isPending} className="rounded-xl bg-[linear-gradient(90deg,#d946a8,#b25ad9)] px-3 py-2 text-sm font-black text-[var(--noc-t1)]">Improve and Regenerate</button>
                            )}
