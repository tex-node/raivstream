          ...
          <Card>
            ...
            {mySubmission ? (
              <div>
                ...
                {mySubmission.project && <Link href={`/story-playground/${mySubmission.project.id}?academyAssignment=${assignmentId}`} className="mt-4 block rounded-xl bg-white/5 p-4 font-black hover:ring-2 hover:ring-[var(--noc-blue)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--noc-blue)]/60">{mySubmission.project.title}</Link>}
