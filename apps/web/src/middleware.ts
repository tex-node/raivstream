...
const SECURITY_HEADERS: Record<string, string> = {
  ...
  'Content-Security-Policy': [
    ...
    "font-src 'self' data:",
    "connect-src 'self' https://api.x.ai https://api.runpod.ai https://api.stripe.com https://*.r2.cloudflarestorage.com https://*.r2.dev https://generativelanguage.googleapis.com https://accounts.google.com wss:",
