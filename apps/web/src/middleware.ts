...
const SECURITY_HEADERS: Record<string, string> = {
  ...
  'Content-Security-Policy': [
    ...
    "media-src 'self' data: blob: https://*.r2.dev https://*.r2.cloudflarestorage.com https:",
    "font-src 'self' data:",
    "connect-src 'self' https://api.x.ai https://api.runpod.ai https://api.stripe.com https://*.r2.cloudflarestorage.com https://*.r2.dev https://generativelanguage.googleapis.com wss:",
    "frame-src 'none'",
    "object-src 'none'",
    "base-uri 'self'",
    "form-action 'self'",
...
const R16_BLOCKED_ROUTES = ['/generate', '/upload', '/credits', '/pricing', '/analytics', '/settings', '/subscription'];
